...
pf_curves.forEach(function(curve) {
    ...
    describe('TEST PAIR ' + curve, function() {
        ...
        if (ctx.ECP.CURVE_PAIRING_TYPE === 1 | ctx.ECP.CURVE_PAIRING_TYPE === 2) {
            ...
            var Qaux = new ctx.ECP8(0);

            var g11 = new ctx.FP48(0);
            var g22 = new ctx.FP48(0);
            var g1s = new ctx.FP48(0);
            var gs1 = new ctx.FP48(0);
            var aux1 = new ctx.FP48(0);
            var aux2 = new ctx.FP48(0);
